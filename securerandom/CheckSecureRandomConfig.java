...
public class CheckSecureRandomConfig {
        ...
        public static void main( String args[] ) {
                ...
                /*
                        1. SecureRandom Configuration: 
                                - Default provider
                                - Default implementation
                                - Default securerandom.source property
                                - self-seeding

                        Observations: 
                                - On Unix like systems: Produces cryptographically secure random pseudo-data. Most prefered option.
                                    - Provider: SUN
                                    - Algorithm: NativePRNG
                                    - securerandom.source: file:/dev/random
                                    - seeding: self-seeding
                                - On Windows systems:  Produces cryptographically secure random pseudo-data. Not the most prefered option, since it defaults to SHA1PRNG.
                                    - Provider: SUN
                                    - Algorithm: SHA1PRNG
                                    - securerandom.source: file:/dev/random 
                                    - seeding: self-seeding
                ...
                /*
                        ...
                        Observations: 
                                - On Unix like systems: Produces cryptographically secure random pseudo-data.
                                    ...
                                    - Algorithm: NativePRNG
                                    - securerandom.source: file:/dev/random 
                                    - seeding: explicit seeding
                                - On Windows systems:  DANGEROUS. SHA1PRNG algorithm is directly seeded with user supplied source of entropy. This makes output directly proportional to source of randomness. 
                                    - Provider: SUN
                                    - Algorithm: SHA1PRNG
                                    - securerandom.source: file:/dev/random 
                                    - seeding:  explicit seeding
                ...
                */  
                ...
                /*
                        3. SecureRandom Configuration: 
                                - Default provider
                                - Algorithm: SHA1PRNG
                                - Default securerandom.source property: file:/dev/random
                                - self-seeding

                        Observations: 
                                - On Unix like systems: Produces cryptographically secure random pseudo-data. SHA1PRNG is seeded using file:/dev/random
                                    - Provider: SUN
                                    - Algorithm: SHA1PRNG
                                    - securerandom.source:  file:/dev/random
                                    - seeding: self-seeding
                                - On Windows systems:  Produces cryptographically secure random pseudo-data. SHA1PRNG is seeded using file:/dev/random
                                    - Provider: SUN
                                    - Algorithm: SHA1PRNG
                                    - securerandom.source: file:/dev/random
                                    - seeding:  self-seeding
                ...
                */
                ...
                /*
                        4. SecureRandom Configuration: 
                                - Default provider
                                - Default implementation: SHA1PRNG
                                - Default securerandom.source property: file:/dev/random
                                - seeding: explicit

                        Observations: 
                                - On Unix like systems: DANGEROUS. SHA1PRNG implementation is directly seeded with the explicitly configured source of randomness. This makes output directly proportional to source of randomness.     
                                    - Provider: SUN
                                    - Algorithm: SHA1PRNG
                                    - securerandom.source: file:/dev/random
                                    - seeding: explicit
                                - On Windows systems: DANGEROUS. SHA1PRNG implementation is directly seeded with the explicitly configured source of randomness. This makes output directly proportional to source of randomness.  
                                    - Provider: SUN
                                    - Algorithm: SHA1PRNG
                                    - securerandom.source: file:/dev/random
                                    - seeding:  explicit
                ...
                */
                ...
                /*
                        5. SecureRandom Configuration: 
                                - Default provider
                                - Default implementation: SHA1PRNG
                                - Changed securerandom.source property: file://something-other-than-dev-random
                                - self-seeding
                        ...
                        Observations: 
                                - On Unix like systems: Produces cryptographically secure random pseudo-data. 
                                    - Provider: SUN
                                    - Algorithm: SHA1PRNG
                                    - securerandom.source: file://something-other-than-dev-random
                                    - seeding: self-seeding
                ...
                */
                ...
                /*
                        6. SecureRandom Configuration: 
                                - Default provider
                                - Default implementation: SHA1PRNG
                                - Default securerandom.source property: file:/something-other-than-dev-random
                                - seeding: explicit
                ...
                */
                ...
                /*      9. SecureRandom Configuration: 
                                - Default provider
                                - implementation: Windows-PRNG
                                - securerandom.source property: file:/something-other-than-dev-random
                                - self-seeding

                        Observations: 
                                - On Unix like systems: Throws NoSuchAlgorithmException
        ...
        */
        protected static void printRandomnessParameters(SecureRandom secRan, String prefixMessage) throws NoSuchAlgorithmException {
